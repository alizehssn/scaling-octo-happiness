...
When the search by nutrients is selected, a varirty of nutrition inputs are displayed which allow the user to set a minimum or maximum for a given nutrient.  Above the search button there is an imput whcih allows the user to control how many recipes to search for.   <img src="assets/images/recipe2.png" width="400px"><br> The final search option is to search randomly.  There are many checkboxes to choose from ranging from vegan, main course, appetizer, beveverage and bread to name a few.  There is also a secton for the most commom intolerances which allows the user to filter out recipres that contain peanuts, gluten, dairy etc. <br> <img src="assets/images/recipe3.png" width="500px"><br>
